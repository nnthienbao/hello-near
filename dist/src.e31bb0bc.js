...
var CONTRACT_NAME = "hello.rubikone.testnet" || 'hello-smart-contract';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/nntb", "/.near/validator_key.json"),
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return new _nearApiJs.Contract(window.walletConnection.account(), nearConfig.contractName, {
              ...
              viewMethods: ['get_hello'] // Change methods can modify the state. But you don't receive the returned value when called.
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, fieldset, name;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, name = _event$target$element.name; // disable the form while the value gets updated on-chain

            fieldset.disabled = true;
            _context.prev = 3;
            _context.next = 6;
            return window.contract.get_hello({
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38877" + '/');
